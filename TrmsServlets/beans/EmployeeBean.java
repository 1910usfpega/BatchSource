...
public class EmployeeBean {
	...
	public EmployeeBean(String employee_password, int direct_supervisor_id, String department,
	...
	public String toString() {
		return "EmployeeBean [employee_id=" + employee_id + ", employee_password=" + employee_password
				+ ", direct_supervisor_id=" + direct_supervisor_id + ", department=" + department
