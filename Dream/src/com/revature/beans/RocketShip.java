...
public class RocketShip {
	...
	//static code block
	static {System.out.println("Team rocket blast off at the speed of light");}
...
//getters/setters
	...
	//instance code block
	{System.out.println("Surrender now or prepare to fight!");}

	@Override
	public String toString() {
		return "RocketShips [numOfRockets=" + numOfRockets + ", color=" + color + ", model=" + model + ", hasMiniFridge="
				+ hasMiniFridge + "]";
	}
