...
In a Driver class, which should be in a different class, instantiate 5 RocketShips and then see if any 
of those objects match.
...
public class RocketShip {
	...
	static {System.out.println("These rocketships are Caribbean themed! :D");}
	
	{System.out.println("Ready, set, launch!!! ");}
