 ...
 * @author Bryan Wood
 *
 * Each question will have a corresponding JUnit to test.
 * CORE JAVA ASSIGNMENT:Due Monday 10/21 @ 5pm
 * Instructions:
 * Create one Java project for the homework with a separate class for each 
 * question. 
 * Utilize a driver class to run all of the question classes from the main
 *  method. 
 * Use comments liberally in your code. Finally, create at least one Unit test 
 * for each question.
 *
...
public class HomeworkDriver {
	...
	public static void main(String[] args) {
		...
		// here are the various results and test cases for my junits
